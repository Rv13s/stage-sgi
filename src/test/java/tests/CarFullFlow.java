...
public class CarFullFlow extends BaseTest {
	...
	public void carHomeTest() throws InterruptedException {
		...
		sgiHome.login("TN01PKM1003", "7000001003");
		...
		if (carDetailsPage.isCarDetailsPage()) {
			...
			carDetailsPage.fillCarDetailsIfPresent("MARUTI SUZUKI", 
					"ALTO 800 VXI - PETROL", 
					"30", "May", "2018",
					"2017", 
					"comprehensive", 
		...
		if (ownerPage.isOwnerDetailsPage()) {
			...
			ownerPage.fillOwnerDetailsPage("Kapil Sunil", 
					"kapill@sunil.com", 
					"Velachery", 
					"ALl area", 
					"600042",
		...
		if (verifyPage.isVerifyCarDetailsPage()) {
			...
			verifyPage.fillVerifyCarPolicyDetailsPage("chassis123", "engine123", "ACKO GENERAL INSURANCE LTD",
					"5344/31/24/0001");
		...
		if(kycFill.isKycFormPage()) {
			System.out.println(">>In KYC Page");
...
//
//		kycFill.enterFirstName("Gopal");
//		kycFill.enterLastName("Murugan");
//
//		kycFill.selectInsureDOB("13", "Jan", "2000");
//		kycFill.selectResidantalAddress("RESIDENT INDIVIDUAL");
//
//		kycFill.enterFatherName("Lavdu");
//		kycFill.enterMotherName("TUNTUN");
//
//		kycFill.selectMaritalStauts("Married");
//		kycFill.enterSpouseName("Meera");

		kycFill.clickContinueButton();
...
//		verifyPage.clickContinueBtn();
		 ...
		 * ownerPage.enterAddressLine2("ALl area"); ownerPage.enterPincode("600042");
		 * 
		 * ownerPage.enterPanNum("QWERT1234Y"); ownerPage.enterPanDOB("01", "Jan",
		 * "2000" );
		 * 
		 * 
		 ...
		 * 
		 * 
		 * ownerPage.clickContinueButton(); ownerPage.ckycSuccessModal();
		 */
